...
const productDocumentSchema = appwriteDocumentMetaSchema.extend({
  ...
  image_file_id: z.string().nullish(),
...
const offerDocumentSchema = appwriteDocumentMetaSchema.extend({
  ...
  product_id: z.string().nullish().transform((value) => value ?? ""),
  produktID: z.string().nullish().transform((value) => value ?? ""),
  year: z.unknown().optional(),
  available_quantity: z.unknown().optional(),
  mengeVerfuegbar: z.unknown().optional(),
  unit: z.string().nullish().transform((value) => value ?? ""),
  ...
  sowing_date: z.string().nullish().transform((value) => value ?? ""),
  saatPflanzDatum: z.string().nullish().transform((value) => value ?? ""),
  ...
  pickup_at: z.string().nullish(),
  created_by_user_id: z.string().nullish(),
  updated_by_user_id: z.string().nullish(),
