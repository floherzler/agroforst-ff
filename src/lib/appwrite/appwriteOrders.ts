...
const orderDocumentSchema = appwriteDocumentMetaSchema.extend({
  ...
  abholung_ab: z.string().nullable().optional(),
  pickup_slot_start: z.string().nullable().optional(),
  pickup_slot_end: z.string().nullable().optional(),
  pickup_slot_label: z.string().nullable().optional(),
  pickup_location: z.string().nullable().optional(),
  pickup_note: z.string().nullable().optional(),
  cancel_deadline_at: z.string().nullable().optional(),
  produkt_name: z.string().nullable().optional(),
  ...
  storniert_am: z.string().nullable().optional(),
  storniert_von: z.string().nullable().optional(),
  storno_grund: z.string().nullable().optional(),
  confirmed_at: z.string().nullable().optional(),
  confirmed_by: z.string().nullable().optional(),
  erfuellt_am: z.string().nullable().optional(),
  erfuellt_von: z.string().nullable().optional(),
});
